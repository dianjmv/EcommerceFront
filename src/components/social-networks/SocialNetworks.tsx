...
const SocialNetworks = ({widthCatalog}:any) => {
    ...
    const catalog = (
        ...
        <div className={'text-center'}>
            <p>
                Descarga nuestro catálogo de productos 2020, en Southimport todos nuestros productos tienen
                1 año de garantía REAL
            </p>
        ...
        <div className={'col-lg-4'}>
            ...
            <div className={'grid grid-cols-1'}>
                <div className={'text-blue-700 font-bold text-2xl flex mb-7'}>
                    <span className={'text-3xl mr-3'}><MdPlace/></span>
                    <p>Dirección</p>
                </div>
                ...
                <div className={'text-blue-700 font-bold text-2xl flex mb-7'}>
                    <span className={'text-3xl mr-3'}><MdPhone/></span>
                    <p>Línea Directa</p>
                </div>
                <div className={'text-blue-700 md:pl-12'}>
                    <AppLink href={`tel:+593${companyInfo.phone_contact}`}>
                        {companyInfo.phone_contact}
                    </AppLink>
                </div>
            ...
            <div className={'mt-3 row'}>
                <div className={'col-lg-8'}>
                    ...
                    <div className={'social-network h-full'}>
                        <Iframe url={faceBookUrl} width={'350px'} height={'500px'} />
                        <Iframe
                            url={'https://youtube.com/embed/videoseries?list=PLvAQRm0AjsSrKWm3ef91CY93yMpMCfcOP'}
                            width={'350px'}
                            height={'500px'}
                        />
