                    ...
                    <div className="document">
                        ...
                        <div className="document__content typography">
                            <p>
                                ...
                                feugiat ante vitae ultricies malesuada.
                            </p>
                            ...
                            <ol>
                                <li>
                                    <strong>Risus</strong>— Morbi posuere eleifend sollicitudin. Praesent eget ante in
                                ...
                                <li>
                                    <strong>Praesent</strong>— Class aptent taciti sociosqu ad litora torquent per
                                    conubia nostra, per inceptos himenaeos. Nulla orci ante, viverra in imperdiet in,
                                    pharetra et leo
                                </li>
                                <li>
                                    <strong>Vestibulum</strong>— Vestibulum arcu tellus, aliquam vel fermentum
