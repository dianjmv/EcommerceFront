...
function ProductsView(props: ProductsViewProps) {
                ...
                if (filter.type === 'categories' || filter.type === 'brands' || filter.type === 'segments') {
                    productsFiltered = products.filter(produc => {
                        return (
                            ...
                            produc.sale_price >= min &&
                            produc.sale_price <= max
                        );
                    });
                }
            }
    ...
    const productsListItems = productsPaginated.map(paginated => {
        if (paginated.page === page) {
            return paginated.products.map(product => (
                <div
                    key={product.id}
        ...
        content = (
            <div className="products-view__content">
                <div className={'grid grid-cols-12 gap-x-8'}>
                    ...
                    <div className={'md:col-start-4 md:col-span-8 col-start-1 col-span-12 mr-2 md:mr-0'}>
                        ...
                        >
                            <div
                                className={
                                    layout === 'grid' || layout === 'grid-with-features'
                                        ? 'products-list__body grid md:grid-cols-4 grid-cols-1 gap-y-3 gap-x-3 '
                                        : 'products-list__body '
                                }
                            >
                                {productsListItems}
            ...
            <div className="products-view__content">
                <div className={'grid grid-cols-12 gap-x-8'}>
                    ...
                    <div className="products-view__empty md:col-start-4 md:col-span-8 col-start-1 col-span-11">
                        ...
                        <div className="products-view__empty-subtitle text-center">
                            Intenta cambiando tus parámetros de busqueda{' '}
                        </div>
                    </div>
                </div>
            </div>
