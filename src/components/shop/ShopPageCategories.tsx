...
function ShopPageCategories(props: ShopPageCategoryProps) {
    const { columns, viewMode, sidebarPosition = 'start', category } = props;
    ...
    return (
        <Fragment>
            ...
            <div
                ...
                style={{
                    backgroundImage: `url(${process.env.NEXT_PUBLIC_BASE_URI}${category.banner.url})`,
