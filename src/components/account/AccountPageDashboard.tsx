...
export default function AccountPageDashboard() {
    ...
    const imageAvatar = () => {
        ...
        if (userLogged.userLogged?.user.avatar) {
            return (<img src={`${process.env.NEXT_PUBLIC_BASE_URI}${userLogged.userLogged.user.avatar.url}`} alt=""
        ...
        <div className="dashboard">
            ...
            <div className="dashboard__profile card profile-card">
                <div className="card-body profile-card__body">
                    ...
                    <div
                        className="profile-card__name">{userLogged.userLogged?.user.first_name} {userLogged.userLogged?.user.last_name}</div>
