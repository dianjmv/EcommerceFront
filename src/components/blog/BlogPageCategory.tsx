...
function BlogPageCategory(props: BlogPageCategoryProps) {
    ...
    return (
        <Fragment>
            ...
            <div className={'w-full text-center pt-14  '} style={{
            ...
            <div className="px-4 mt-8">
                <div className={'grid md:grid-cols-12 grid-cols-1 gap-x-6 gap-y-2'}>
                    <div className={'col-start-1 md:col-span-2 md:pt-4'}>
