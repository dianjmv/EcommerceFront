...
const InfoWindow = (props: any) => {
    ...
    return (
        ...
        <div style={infoWindowStyle}>
            <div style={{ fontSize: 16 }}>SouthImport</div>
            <div style={{ fontSize: 14 }}></div>
            <div style={{ fontSize: 14, color: 'grey' }}>Las mejores Ofertas</div>
            <div style={{ fontSize: 14, color: 'grey' }}>Los mejores PRecios</div>
            <div style={{ fontSize: 14, color: 'green' }}>Horario de atención</div>
        </div>
    );
};
// Marker component
