...
function Page({ products, brand }: PageProps) {
    ...
    return (
        <div className={'grid grid-cols-1'}>
            <Head>
                <title>
                    {companyInfo !== undefined ? companyInfo.company_name : null} |{' '}
                    {actualBrand ? actualBrand.name : brand.name}
                </title>
            </Head>
            ...
            <div className={'col-start-1 container'}>
                <div className={'text-center items-center content-center  mb-10'}>
                    <img
                        ...
                        src={`${process.env.NEXT_PUBLIC_BASE_URI}${brand.thumbnail_image.url}`}
                        alt=""
                    />
                ...
                <div className={'grid md:grid-cols-3 grid-cols-1 container md:gap-y-6 gap-y-4 my-10'}>
                    ...
                    <div className={'md:col-start-1 md:col-span-2 col-start-1'}>
                        ...
                        <img
                            className={'mx-auto'}
                            src={`${process.env.NEXT_PUBLIC_BASE_URI}${brand.certificate_images.url}`}
                            alt=""
                        />
                    </div>
